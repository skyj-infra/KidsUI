...
export default function HearFromKids() {
  ...
  return (
    <section
      className="relative w-full h-[1300px] pt-[15rem] text-center
    ...
    >
      ...
      <div
        className="
          w-[250px] transform rotate-[14deg]
      ...
      {/* ---------- Paragraph ---------- */}
      <p
        className="text-white text-center mt-6 px-8 text-sm
                   leading-relaxed max-w-md mx-auto opacity-90"
      >
      ...
      <div className="max-w-[1500px] mx-auto mt-16">
        ...
        >
          {slides.map((item, i) => (
            <SwiperSlide key={i}>
              <div
                className="w-full h-[450px] lg:h-[650px] rounded-3xl overflow-hidden
                           shadow-xl border border-orange-400 bg-white/5 p-3"
              >
                <img
                  src={item.img}
      ...
      <div
        className="
          absolute left-1/2 bottom-[-58px] -translate-x-1/2
          md:bottom-[-60px] w-[220px] md:w-[230px]
          rotate-[22deg] z-20 lg:right-10 lg:left-auto
        "
      >
        <Image
